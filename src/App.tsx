  ...
  return (
    <>
      ...
      <div className="lg:col-span-1 my-5 max-w-xl mx-5">
        <div className="bg-white shadow-xl  h-full flex flex-col border-2 border-amber-400">
          ...
          <div className="p-4 border-t bg-white ">
            <form className="flex space-x-2">
              <input className="flex-1 px-3 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent text-black" />
